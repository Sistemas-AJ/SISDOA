...
from .CarpetasProyectoService import (
	get_carpetas, get_carpeta, create_carpeta, update_carpeta, delete_carpeta
)
from .CarpetasProyectoShchema import CarpetaCreate, CarpetaUpdate, CarpetaOut

router = APIRouter(prefix="/carpetas-proyecto", tags=["CarpetasProyecto"])
...
@router.post("/carpetas", response_model=CarpetaOut)
