...
const VistaDetalles = ({ carpetas, onEntrarCarpeta, onContextMenu }) => {
  ...
  const headerStyle = {
    display: 'grid',
    gridTemplateColumns: '40px 2fr 120px 120px 100px 1fr',
    gap: '16px',
    padding: '12px 16px',
    ...
    return (
      ...
      >
        ...
        <div style={{ 
          ...
          {fechaModificacion ? fechaModificacion.toLocaleDateString('es-ES') : '--'}
        </div>
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={headerStyle}>
        ...
        <div>Fecha modificación</div>
        <div style={{ textAlign: 'center' }}>Tipo</div>
        <div style={{ textAlign: 'right' }}>Detalles</div>
      </div>
